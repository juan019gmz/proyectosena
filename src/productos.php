    ...
    if (empty($codigo) || empty($producto) || empty($tipo) || empty($presentacion) || empty($laboratorio)  || empty($precio) || $precio <  0 || empty($cantidad) || $cantidad <  0) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO producto(codigo,descripcion,precio,existencia,id_lab,id_presentacion,id_tipo, vencimiento, fecha_ingreso) values ('$codigo', '$producto', '$precio', '$cantidad', $laboratorio, $presentacion, $tipo, '$vencimiento', '$fecha_ingreso')");
                if ($query_insert) {
            ...
            $query_update = mysqli_query($conexion, "UPDATE producto SET codigo = '$codigo', descripcion = '$producto', precio= $precio, existencia = $cantidad, vencimiento = '$vencimiento', fecha_ingreso = '$fecha_ingreso' WHERE codproducto = $id");
            if ($query_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Producto Modificado
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <form action="" method="post" autocomplete="off" id="formulario">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                        ...
                                        <label for="vencimiento">Ingreso</label>
                                        <input id="fecha_ingreso" class="form-control" type="date" name="fecha_ingreso">
                                </div>
                            </div>
                                <div class="col-md-3">                
                                    <div class="form-group">
                                        <label for="codigo" class=" text-dark font-weight-bold"><i class="fas fa-barcode"></i> Código Producto</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="laboratorio">PROVEEDOR</label>
